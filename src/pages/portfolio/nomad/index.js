        ...
        <section className="content-container">
          <div className="row">
            <section className="col-xs-12 col-sm-8 col-sm-offset-2 portfolio-copy--second-row">
              ...
              <p className="load-in">
                I have a unique hybrid role at Nomad: I’m a backend developer,
                front-end developer and system architect, I am the Lead Product
                Engineer. I spent half of my time designing features, and the
                other half building them.
              </p>
            </section>
          </div>
        </section>
