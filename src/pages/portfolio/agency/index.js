        ...
        <section className="content-container">
          ...
          <div className="row center">
            <div className="col-xs-12 col-sm-8">
              <p className="load-in">
                I spent a few years working at interactive ad agencies.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="row">
            <section className="col-xs-12 col-sm-8 col-sm-offset-2 portfolio-copy--second-row">
              ...
              <p className="load-in">
                ...
                high-level of design sophistication. I worked as a Senior
                Developer, mainly focusing on frontend heavy projects. Including
                a major redesign for <em>USA Today</em>, embedding with the
                Gannett team in Virginia. I also worked on several Google
                projects, including <em>Project Re:Brief</em> — iconic
                advertising campaigns reimagined for the 21st century, Google
                Zeitgeist and <em>Think with Google</em>, and a Google Chrome
                app for Al-Jazeera.
              </p>
            </section>
          </div>
